...
public class IOSNativeSettingsEditor : Editor {
	...
	private static string IOSNotificationController_Path 	= ISN_SCRIPTS + "Messaging/Notifications/Controllers/IOSNotificationController.cs";
	private static string DeviceTokenListener_Path 			= ISN_SCRIPTS + "Messaging/Notifications/Controllers/DeviceTokenListener.cs";
	...
	public static void DisableAdditionalFeatures() {
		...
		SA.Common.Editor.Tools.ChnageDefineState(IOSNotificationController_Path, 		"PUSH_ENABLED", false);
		SA.Common.Editor.Tools.ChnageDefineState(DeviceTokenListener_Path,		 		"PUSH_ENABLED", false);
	}
	...
	public static void UpdatePluginSettings() {
		...
		SA.Common.Editor.Tools.ChnageDefineState(IOSNotificationController_Path, 		"PUSH_ENABLED", IOSNativeSettings.Instance.EnablePushNotificationsAPI);
		SA.Common.Editor.Tools.ChnageDefineState(DeviceTokenListener_Path,		 		"PUSH_ENABLED", IOSNativeSettings.Instance.EnablePushNotificationsAPI);
